...
Update of the following table: 2024-03-27 20:22 CEST

| File | Number of domains |
| ---- | ---------------- |
| full-domains-aa.txt | 106 958 |
...
| phishing.army | [link](https://phishing.army/) | Phishing domain (only .fr domains) |
...
| ut1-fr | [link](https://dsi.ut-capitole.fr/blacklists/) | Malware and phishing domains (only .fr domains) |
| full-domains-\* | | All domains, sorted by relevance (domains present in most sources first), duplicates and false positives removed |
